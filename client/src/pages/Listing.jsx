        ...
        <main>
            ...
            {listing && !loading && !error && (
                <>
                    ...
                    <div className="flex flex-row mx-auto p-3 my-7 gap-2">
                            <div className={`${listing.lat && listing.lng && isLoaded ? 'm-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 lg:space-x-5' : 'flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'}`}>
                                <div className="w-full">
                                    ...
                                    <ul className='flex items-center gap-4 sm:gap-6 text-green-900 font-semibold text-sm mt-2 flex-wrap'>
                                        <li className='flex items-center gap-1 whitespace-nowrap'>
                                            <FaHome className='text-md md:text-lg' />
                                            {listing.size}
                                        </li>
                                        <li className='flex items-center whitespace-nowrap'>
                                            {listing.indoorPlumbing ? (
                                                <div className='flex items-center gap-3'>
                                                    <FaFaucetDrip className='text-md md:text-lg'/>
                                                    <p>Water available</p>
                                                </div>   
                                            ) : (
                                                <>
                                        ...
                                        <li className='flex items-center gap-1 whitespace-nowrap'>
                                            {listing.wifi ? (
                                                <div className='flex items-center gap-3'>
                                                    <FaWifi className='text-md md:text-lg'/>
                                                    <p>WiFi Available</p>
                                                </div>
                                            ) : (
                                                <div className="flex items-center gap-3">
                                                    <BiWifiOff className='text-md md:text-lg' />
                                                    <p>No WiFi</p>
                                                </div>
                                            )}
                                        </li>
                                        <li className='flex items-center gap-1 whitespace-nowrap'>
                                            {listing.distance ? (
                                                <div className="flex items-center gap-3">
                                                    <FaRoad className='text-md md:text-lg'/>
                                        ...
                                        <li className='flex items-center gap-1 whitespace-nowrap'>
                                            {listing.duration ? (
                                                <div className="flex items-center gap-3">
                                                    <MdTimer className='text-md md:text-lg'/>
                                ...
                                <div className={`${listing.lat && listing.lng && isLoaded ? 'w-11/12 h-[200px] md:h-[300px] z-10 overflow-x-hidden mt-6 md:mt-0 md:ml-2 border-black rounded-lg' : ''}`}>
